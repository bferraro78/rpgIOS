...
+(void)loadWeapons {
    ...
    [weaponLibrary addObject:[[Weapon alloc] initForRandomStatsweaponID:10 weaponName:@"1000 Truths" weaponType:SWORD twoHand:false MH:true]];
...
+(Weapon*)generateRandomWeapon {
    ...
    Weapon *chosenWeapon = [[Weapon alloc] initForRandomStatsweaponID:tmpWeapon.weaponID weaponName:tmpWeapon.weaponName weaponType:tmpWeapon.weaponType twoHand:tmpWeapon.twoHand MH:tmpWeapon.isMainHand];
    ...
    // TODO
    /* Generate Stats */
    chosenWeapon.weaponVit = 10;
    chosenWeapon.weaponStrn = 10;
    chosenWeapon.weaponDext = 10;
    chosenWeapon.weaponInti = 10;
     
    /* 30% Chance item is physical damage - *70% elemental */
    int elementalOrPhysical = arc4random_uniform(100);
    if (elementalOrPhysical < 29) {
