    ...
    switch (state) {
        ...
        case UIGestureRecognizerStateChanged: {
            ...
            if (indexPath && ![indexPath isEqual:sourceIndexPath]) {
                ...
                // ... update data source.
                [self.mainCharacter.skillSet exchangeObjectAtIndex:indexPath.row withObjectAtIndex:sourceIndexPath.row];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [_mainCharacter.skillSet count];
}
...
//    [cell addGestureRecognizer:lpgr];
    ...
    cell.textLabel.text = [_mainCharacter.skillSet objectAtIndex:indexPath.row];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *skillName = [self.mainCharacter.skillSet objectAtIndex:index];
    
    self.moveView = [[UITextView alloc] initWithFrame:CGRectMake(cell.center.x, cell.center.y, 200, 0)];
